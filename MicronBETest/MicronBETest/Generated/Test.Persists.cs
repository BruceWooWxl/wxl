...
namespace MicronBETest.Persists
{
    
    /// <summary>
    /// Test Persist Model class
    /// </summary>
    public partial class Test_Persist : PersistModule
    {
        ...
        {
            private MicronBETest.Logic.PersistInputs fPersistInputs = new MicronBETest.Logic.PersistInputs();
            protected override void Configure()
            {
                #region Init Config
                // Init
                ...
                this.Load<ProcessStep>("ProcessStep", false, true, null);
                ...
                this.Load<McpBom>("McpBom", false, true, null);
                this.Action("McpBom", null);
                ...
                this.Load<ActInfo>("ActInfo", false, true, null);
                ...
                // Schedule Persists
                this.StartPerformance();
                this.Load<Equipment>("Equipment", false, true, null);
                ...
                this.Load<StepTime>("StepTime", false, true, null);
                this.Action("StepTime", null);
                this.Load<SetupInfo>("SetupInfo", false, true, null);
